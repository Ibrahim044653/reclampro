...
@router.get("/sla-check", summary="Escalade automatique SLA")
def sla_check(
    ...
    Passe à ALERTE tous les dossiers dont le SLA est consommé à plus de 80%.
    """
    return sla_escalade.escalader_dossiers_en_retard(db)
